...
useEffect(() => {
  if(number > 100) {
    ...
    const animation = animate(count, number, { duration: 0.1 * number });
    return animation.stop;
  }, []);
  return (
  <NumberTitle>
...
const NumberSection=() => {
  ...
  return (
    <NumberBlock ref={ref} >
     {isInView ? <NumberContainer>
          <CenterBlock>
           <NumberItem number={250}></NumberItem><Plus>+</Plus>
          ...
          <FlexList>
            ...
            <Li>
              <NumberItem number={50}></NumberItem><Plus>+</Plus>
